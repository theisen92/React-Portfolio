          ...
          <div className="card col-sm">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Website for someone who wants quickly sort through employees at
                a company by filtering name, email or phone number
              </p>
              <a
        ...
        <div className="row">
          ...
          <div className="card col-sm">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Website for someone on the go who wants to track and update
                their budget in places that might not have internet
              </p>
              <a
